            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card">
                            <a href="https://www.thegioididong.com/dtdd-apple-iphone-16-series">
                                <img src="img/dh1.jpg" class="card-img-top" alt="SERIES-4">
                            </a>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card">
                            <a href="#">
                                <img src="img/dh2.jpeg" class="card-img-top" alt="DÂY WC TITAN">
                            </a>
                            <div class="card-body text-center">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card">
                            <a href="#">
                                <img src="img/t5000.jpg" class="card-img-top" alt="WC-9">
                            </a>
                            <div class="card-body text-center">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card">
                            <a href="#">
                                <img src="img/dh4.jpg" class="card-img-top" alt="WC-3">
                            </a>
                            <div class="card-body text-center">
